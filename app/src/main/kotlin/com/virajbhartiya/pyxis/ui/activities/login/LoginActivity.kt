...
import com.virajbhartiya.pyxis.utils.Consts.TYPE_CHILD
import com.virajbhartiya.pyxis.utils.Consts.TYPE_PARENT
import com.virajbhartiya.pyxis.utils.KeyboardUtils
...
class LoginActivity : BaseActivity(R.layout.activity_login), InterfaceViewLogin, KeyboardUtils.SoftKeyboardToggleListener {
    ...
    override fun onStart() {
        ...
        if (interactor.user() != null){
            if (typeApp) startMain(NotifyMessageFragment.TAG)
