...
import com.virajbhartiya.pyxis.BuildConfig
...
import com.virajbhartiya.pyxis.ui.adapters.basedapter.FirebaseOptions
...
import com.virajbhartiya.pyxis.utils.Consts.APP_DISABLED
import com.virajbhartiya.pyxis.utils.Consts.APP_ENABLED
import com.virajbhartiya.pyxis.utils.Consts.COMMAND_ENABLE_GPS_PROVIDER
import com.virajbhartiya.pyxis.utils.Consts.COMMAND_ENABLE_NETWORK_PROVIDER
import com.virajbhartiya.pyxis.utils.async.AsyncTaskRootPermission
...
object ConstFun {
    ...
    inline fun <reified T : Any> Activity.startAnimateActivity() { startActivity<T>() ; animateActivity(com.virajbhartiya.pyxis.R.anim.fade_in,com.virajbhartiya.pyxis.R.anim.fade_out) }
    ...
    fun Activity.startMain(fragmentTag:String){
        Intent(this,MainParentActivity::class.java).also {
            ...
            it.start(this)
            finish()
            animateActivity(com.virajbhartiya.pyxis.R.anim.fade_in,com.virajbhartiya.pyxis.R.anim.fade_out)
        }
    }
    ...
    fun Context.alertDialog(alertType: Int, title: Int, msg: String?, txtPositiveButton: Int?, cancellable: Boolean = false, action: SweetAlertDialog.() -> Unit): SweetAlertDialog {
        val dialog = SweetAlertDialog(this, alertType).apply {
            ...
            } else progressHelper.barColor = ContextCompat.getColor(this@alertDialog, com.virajbhartiya.pyxis.R.color.colorPrimary)
        }
        action(dialog)
        return dialog
    }
    ...
    fun Context.sendToGoogleMaps(latitude:String,longitude:String){
        try {
            ...
            Intent(Intent.ACTION_VIEW,uri).also {
                ...
                else longToast(com.virajbhartiya.pyxis.R.string.maps_installed)
            }
        }catch (t:Throwable){
            longToast(com.virajbhartiya.pyxis.R.string.maps_installed)
        }
    }
